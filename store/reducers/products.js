...
export default (state = initialState, action) => {
  switch (action.type) { // action.type is the same as the type property in the action object  
    ...
    case DELETE_PRODUCT: //  deleteproduct is the same as the pid property in the action object 
      return {
        ...state,
        userProducts: state.userProducts.filter( // filter the userProducts array to remove the product with the id of the action.pid
